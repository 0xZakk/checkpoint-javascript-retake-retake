...
var numbers = [20, 10, 5, 9];

function myFunction() {
  let ghostBusters = document.getElementById("ghostBuster");
  ghostBusters.innerHTML = numbers.map(Math.sqrt);
}
...
const result = words.filter(word => num.length < 11);
