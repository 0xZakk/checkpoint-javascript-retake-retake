...
var superHeroes = ["ironman", "captainamerica", "batman"];
// #2: Access the last item in the array and assign to a variable called `last`.
// Type your solution immediately below this line:
var last = ironman[ironman.length - 1];
...
for (var i = 0; i <= superHeroes.length; i++) {
  return favoriteHeroes.push(superHeroes[i]);
}
...
// a boolean value.
 Batman.push(has-secret-lair) = "true"
// Type your solution immediately below this line:
